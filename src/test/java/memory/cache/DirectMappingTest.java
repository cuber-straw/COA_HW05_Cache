...
public class DirectMappingTest {
    ...
    public void test01() {
        ...
        char[] data = {0b11110000, 0b10101011, 0b000101011, 0b10100001, 0b00111100, 0b10011101}; // 6个最小可寻址单元的数据
        ...
        char[] dataRead = cache.read(eip, data.length); // 读出从地址eip开始的6个最小可寻址单元的数据
        // 判断是否能够正确读出数据
